...
public class GeminiService {
    ...
    public Mono<String> generateRecoBook(List<Book> listBooks) {
        ...
        String books = listBooks.stream()
                .map( book -> String.format("Nome: %s, Genero: %s, Data de inicio da leitura: %s, Data de fim da leitura: %s, Avaliação do livro: %s", book.getName(), book.getGenre(), book.getDateStart(), book.getDateEnd(), book.getEvaluation()))
